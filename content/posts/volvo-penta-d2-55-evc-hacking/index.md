...
description: "정품 장비 가격 대비 약 5만원 안쪽 비용으로 볼보 펜타 엔진 데이터를 WiFi로 전송하는 방법. ESP32와 CAN 통신 모듈을 이용한 DIY 가이드."
...
볼보 펜타 엔진 데이터를 모니터링하려면 정품 게이트웨이나 비싼 NMEA 2000 변환기를 사야 합니다. 가격을 알아보니 헉, 소리가 절로 나오더라고요. 그래서 직접 만들어보기로 했습니다.

놀랍게도 **약 5만원 안쪽**이면 충분합니다.
...
작은 만능기판에 오밀조밀 배치했습니다.

![만능기판에 조립된 하드웨어 모습](IMG_9756.JPG)
...
"볼보 펜타 엔진의 CAN 데이터를 읽어서 시리얼 모니터에 뿌려주는 코드를 짜줘."
...
이 작업은 엔진을 개조하는 게 아닙니다. 이미 엔진 내부에서 흐르고 있는 데이터를 **"조용히 듣는 것(Sniffing)"**에 가깝습니다.
