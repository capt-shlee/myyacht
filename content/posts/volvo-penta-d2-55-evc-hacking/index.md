...
seoTitle: "볼보 펜타 D2-55 EVC 엔진 데이터 읽기 | ESP32 Wi-Fi 모니터링 DIY"
date: 2026-02-14T17:00:00+09:00
summary: "볼보 펜타 D2-55 EVC 데이터를 ESP32와 CAN 모듈로 수신해 Wi-Fi로 보내는 준비 과정을 정리했습니다. 정품 게이트웨이 없이 엔진 상태 모니터링을 시작한 기록입니다."
description: "ESP32와 CAN 모듈로 볼보 펜타 D2-55 EVC 데이터를 읽어 Wi-Fi로 전송하는 DIY 가이드입니다. 정품 게이트웨이 없이 엔진 상태 모니터링을 준비한 과정을 정리했습니다."
...
* **전원(12V)**과 **그라운드(GND)** 위치 확인 (제경우 6번과 4번)
* **CAN High**와 **CAN Low** 식별 (제경우 5번과 2번)
...
이 작업은 엔진을 개조하는 게 아닙니다. 이미 엔진 내부에서 흐르고 있는 데이터를 **수신 전용으로 읽는 것(Listen-only)** 에 가깝습니다.
...
* **[4만원으로 요트 전력 관리 시스템 구축하기: KM110F 데이터 연동 & OpenPlotter]({{< ref "/posts/km110f-shunt" >}})**: 저렴한 비용으로 구축하는 또 다른 가성비 DIY 프로젝트입니다.
