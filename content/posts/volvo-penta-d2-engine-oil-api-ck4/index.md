...
* **[볼보 펜타 D2-55 EVC 엔진 데이터 읽기: Wi-Fi 모니터링 준비]({{< ref "/posts/volvo-penta-d2-55-evc-hacking" >}})**: 엔진 건강 상태를 실시간으로 모니터링하는 스마트한 방법.
* **[4만원으로 요트 전력 관리 시스템 구축하기: KM110F 데이터 연동 & OpenPlotter]({{< ref "/posts/km110f-shunt" >}})**: 엔진 시동 배터리와 하우스 배터리를 완벽하게 관리하는 노하우.
